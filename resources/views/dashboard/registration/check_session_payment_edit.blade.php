    ...
    <div class="grid grid-cols-6">
        ...
        <div class="col-span-5 mt-2">
            ...
            <div class="bg-white py-3 px-6 ml-4 mr-8 text-gray-600 my-5 rounded">
                ...
                <div class="p-4">
                <!-- check_payment Edit  -->
                <form action="{{ route('check-payment-session-update', $check_payment->id) }}" method="POST" class="lg:w-5/6 px-6 lg:px-8 py-8">
                    @csrf
                    @method('PATCH')
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2 items-center mt-3">
                            <div class="mr-4">
                                <img class="w-64" src="{{ $check_payment->proof_of_payment }}" alt="{{ $check_payment->studentName($check_payment->student_id) }} Receipt">
                            </div>
                        </div>
